...
class Pacchetto:
    def __init__(self, nome, descrizione, prezzo, numero_lezioni, durata_giorni, pagamento_unico=False):
        self.nome = nome
    ...
    def salva(self):
        return db.add_pacchetto(self.nome, self.descrizione, self.prezzo, self.numero_lezioni, self.durata_giorni, self.pagamento_unico)
